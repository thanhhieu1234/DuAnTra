...
<div style="margin-top: 195px" id="carouselExampleDark"
...
<div class="container mt-5">
	...
	<div id="recipeCarousel" class="carousel slide" data-bs-ride="carousel">
		<div class="heading-product">
			...
			<div style="margin-right: 24px; z-index: 11; margin-block: auto"
				id="recipeCarousel" class="carousel slide" data-bs-ride="carousel">
				<a class="icons-carousel carousel-control-prev bg-transparent w-aut"
					href="#recipeCarousel" role="button" data-bs-slide="next"><i
					class="icofont-thin-right" aria-hidden="true"></i> </a> <a
					class="icons-carousel carousel-control-next bg-transparent w-aut"
					href="#recipeCarousel" role="button" data-bs-slide="prev"> <i
					class="icofont-thin-left" aria-hidden="true"></i>
				</a>
			</div>
		</div>
				...
				<div class="card carousel-itemss">
					<div class="img-container">
						<div
							...
							<span class="percent">-25%</span> <span class="wishlist"><i
								class="fa fa-heart"></i></span>
						</div>
						<a href="/view/details_component.jsp"> <img
						...
						<div
							...
							<div class="size">
								<label class="radio"> <input type="radio" name="size1"
									value="small" /> <span>S</span>
								</label> <label class="radio"> <input type="radio" name="size1"
									value="Medium" checked /> <span>M</span>
								</label> <label class="radio"> <input type="radio" name="size1"
									value="Large" /> <span>L</span>
								</label>
							</div>
						</div>
						<div class="mt-3">
	...
	<div class="d-flex justify-content-center mt-3">
		<span class="text text-center">Finding Best Products Now<br />
			in Your Fingertips
		</span>
	</div>
	<div class="heading-product">
		...
		<div class="col-md-3 item home_product">
			<div class="card">
				<div class="img-container">
					...
					<a href="#!detail/1"> <img style="width: 100%"
						src="http://gongcha.com.vn/wp-content/uploads/2023/05/Tra-sua-Thach-Dao.png"
						class="img-fluid" />
					</a>
				</div>
				<div class="product-detail-container">
					<div class="align-items-center">
						<h6 class="mb-0">Đào Sữa Hoàng Kim</h6>
						<span class="text-danger font-weight-bold">15.000.000đ</span>
					</div>
					...
					<div class="mt-3">
						<button class="btn btn-block">Mua</button>
					</div>
				</div>
			</div>
		</div>
